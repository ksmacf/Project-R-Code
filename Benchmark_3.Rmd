...
false3 <- read_csv("/home/user1/Desktop/var3.csv")
false3 <- subset(false3, col_v3[,1]!=col_v3[,2])

col_f3 <- if_else(false3$Signal_pred=="2", "red", "blue") # blue is FN, red is FP
write_csv(as.data.frame(false3), "/home/user1/Desktop/false3.csv")
...
animation_FPFN(f3, "/home/user1/Desktop/false3.csv", false3)
```

```{r}
# tour for only the misclassified points
fntp3 <- read_csv("/home/user1/Desktop/var3.csv")
fntp3 <- subset(fntp3, fntp3[,"Signal"]=="1")
write_csv(as.data.frame(fntp3), "/home/user1/Desktop/fntp3.csv")
...
X11()
animate_xy(fntp3[,-ncol(fntp3)], planned_tour(sig3), col = col_back3, fps = 50)
X11()

animation_signal(sig3, "/home/user1/Desktop/fntp3.csv", fntp3)
```

```{r}
# tour for only the misclassified points
fptn3 <- read_csv("/home/user1/Desktop/var3.csv")
fptn3 <- subset(fptn3, fptn3[,"Signal"]=="0")
write_csv(as.data.frame(fptn3), "/home/user1/Desktop/fptn3.csv")
...
animation_background(back3, "/home/user1/Desktop/fptn3.csv", fptn3)
```
