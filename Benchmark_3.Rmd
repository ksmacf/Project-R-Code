...
# Save tour history
oldseed <- .Random.seed
t3 <- save_history(var3[,-6], guided_tour(ashapetour(cl = col_v3[,3], alpha = 0.4, hull_var = c("black")), search_f = tourr:::search_better, alpha = pi/2, cooling = 0.5), step_size = Inf)

X11()
animate_xy(var3[,-6], planned_tour(t3), col = col_v3[,3], fps = 50)
X11()
...
# Save the tour plot  
render(var3[,-6], planned_tour(t3), display_xy(col = col_v3[,3]), frames = 50, "png", "/home/user1/Desktop/Images for thesis/tourr/bm3/bm3_proper-%03d.png")
